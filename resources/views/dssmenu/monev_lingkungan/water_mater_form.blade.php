{!! Form::model($model,[
    'route' => $model->exists ? ['water_mater.update', $model->id] : 'water_mater.store',
    'files' => true
]) !!}
    ...
    <div class="col-md-6">
        ...
        {!! Form::number('wmk',null,['class' => 'form-control', 'step' => '0.01', 'id' => 'wmk']) !!}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
        <label for="hasil_wmb">Hasil WMB</label>
        {!! Form::number('wmb',null,['class' => 'form-control', 'step' => '0.01', 'id' => 'wmb']) !!}
        </div>
    </div>
    </div>
    <div class="form-group">
