...
<!-- Data tables monev lingkungan - kelola sumur penduduk -->
<div class="row">
    <div class="col-md-12">
    <div class="card">
        ...
        <div class="row">
            <div class="col-md-3 social-buttons-demo">
                <a href="{{ route('sumur.create') }}" title="Tambah Data" data-target="#modal" class="btn btn-social btn-fill btn-facebook modal-show"><i class="material-icons">add</i>Tambah Data<div class="ripple-container"></div></a>
            </div>
        </div>
