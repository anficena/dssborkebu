...
<!-- Data tables monev lingkungan -->
<div class="row">
    <div class="col-md-12">
    <div class="card">
        <div class="card-header card-header-success">
                <h4 class="card-title ">Kelola Data Monev Lingkungan</h4>
                <!-- <p class="card-category"> Here is a subtitle for this table</p> -->
        </div>
        <div class="card-body">
        <div class="bd-example text-right">
            <a href="{{ route('monev_lingkungan.create') }}" title="Tambah Data" data-target="#modal" class="btn btn-outline-primary modal-show"><i class="fa fa-fw fa-plus"></i> Tambah Data<div class="ripple-container"></div></a>
        </div>
...
<script>
   ...
   $('#datatable').DataTable({
      ...
      processing: true,
      serverSide: true,
      ajax:"{{ route('monev_lingkungan.table') }}",
      columns:[
