...
<!-- Data tables monev lingkungan - kelola kedalaman sumur resapan -->
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-success">
                <h4 class="card-title ">Kelola Data Kedalaman Sumur Peresapan</h4>
                <!-- <p class="card-category"> Here is a subtitle for this table</p> -->
            </div>
            <div class="card-body">
                <div class="bd-example text-right">
                    <a href="{{ route('kedalaman_resapan.create') }}" title="Tambah Data" data-target="#modal" class="btn btn btn-outline-primary modal-show"><i class="fa fa-fw fa-plus"></i> Tambah Data<div class="ripple-container"></div></a>
                    <a href="{{ route('kedalaman_resapan.import') }}" title="Import Data" data-target="#modal" class="btn btn-outline-success modal-show"><i class="fa fa-file-excel-o"></i> Import Data</a>
                </div>
...
<script>
   ...
   $('#datatable').DataTable({
      ...
      processing: true,
      serverSide: true,
      ajax:"{{ route('kedalaman_resapan.table') }}",
      columns:[
